...
SKETCH_DIR="$ROOT_DIR/arduino-code/arduino-uno/SmartRobotCarV4.0_V2_20220322_TB6612_QMI8658C"
BUILD_DIR="${BUILD_DIR:-/tmp/arduino-build-uno-qmi}"
...
echo "Project UNO QMI IMU+battery flash complete."

...
SKETCH_DIR="$ROOT_DIR/arduino-code/arduino-uno-stock/SmartRobotCarV4.0_V2_20220322_QMI8658C"
BUILD_DIR="${BUILD_DIR:-/tmp/arduino-build-uno-qmi-stock}"
...
echo "Stock UNO QMI8658C flash complete."
